	...
	<main>
		...
		<div class="bevel-corners">
			...
			<div>
				...
				faucibus. Neque egestas congue quisque egestas. Quis ipsum suspendisse
		...
		<div class="bevel-corners">
			<p>③ Inline SVG</p>
			<div>
				Cras semper auctor neque vitae tempus quam pellentesque nec. Congue
				quisque egestas diam in arcu. Purus in mollis nunc sed id semper risus
				in.
			</div>
		</div>
		<div class="bevel-corners">
			<p>④ clip-path</p>
			<div>
				Molestie ac feugiat sed lectus vestibulum. Eu turpis egestas pretium
				aenean pharetra magna ac. Porttitor eget dolor morbi non arcu risus
				quis.
			</div>
		</div>
	</main>
