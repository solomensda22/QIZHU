...
import HomePage from "@/components/cssYS/ban-Tou-Ming-Bian-Kuang.vue";
import DuoBianKuang from "@/components/cssYS/duo-Bian-Kuang.vue";
...
const routes = [
  {
    path: "/",
    name: "nnnn",
    component: () => import("../views/paage.vue"),
  },
  {
    path: "/cssYS",
    name: "cssYS",
